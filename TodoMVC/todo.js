 ...
 *
 */
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e(require("react"));else if("function"==typeof define&&define.amd)define(["react"],e);else{var f;f="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,f.ReactDOM=e(f.React)}}(function(e){return e.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED});function createClass(cls) {
...
MainView = createClass({
    render: function () {
        return React.createElement(
            "div",
            null,
            React.createElement("input", { className: "toggle-all", id: "toggle-all", type: "checkbox" }),
            React.createElement(
                "label",
                { htmlFor: "toggle-all" },
...
FooterView = createClass({
    item_or_items: function () {
        if (this.state.remaining === 1) return 'item';
        return 'items';
    },
    render: function () {
        return React.createElement(
...
_$rapyd$_modules["vyom"] = {};
_$rapyd$_modules["vyom.parser"] = {};
_$rapyd$_modules["vyom.utils"] = {};
_$rapyd$_modules["vyom.controllers"] = {};
_$rapyd$_modules["vyom.events"] = {};
...
(function(){
    ...
    function value(o) {
        if (o && o.is_observable) {
            return o();
        }
        return o;
    }
    function ReactyWidget() {
        if (this._$rapyd$_object_id === undefined) Object.defineProperty(this, "_$rapyd$_object_id", {"value":++_$rapyd$_object_counter});
        ReactyWidget.prototype.__init__.apply(this, arguments);
    }
    ReactyWidget.prototype.__init__ = function __init__(parent, component, data, evts) {
        var self = this;
        if (!evts) {
            evts = {};
        }
    ...
    ReactyWidget.prototype.init = function init(robj) {
        var self = this;
        self.robj = robj;
        if (self.parent && self.parent.post_create) {
            self.parent.post_create();
        }
    };
    ReactyWidget.prototype.rerender = function rerender(data) {
        var self = this;
        if (!self.robj) {
    ...
    ReactyWidget.prototype.render = function render() {
        var self = this;
        self.evts.state = value(self.data);
        return React.createElement(self.component, self.evts);
    };
    ReactyWidget.prototype.__repr__ = function __repr__ () {
        return "<" + __name__ + "." + "ReactyWidget" + " #" + this._$rapyd$_object_id + ">";
    };
    ReactyWidget.prototype.__str__ = function __str__ () {
        return this.__repr__();
    };

    _$rapyd$_modules["vyom"]["NotPassed"] = NotPassed;

    _$rapyd$_modules["vyom"]["Exception"] = Exception;

    _$rapyd$_modules["vyom"]["value"] = value;

    _$rapyd$_modules["vyom"]["ReactyWidget"] = ReactyWidget;
    _$rapyd$_modules["vyom"]["parser"] = _$rapyd$_modules["vyom.parser"];
    _$rapyd$_modules["vyom"]["utils"] = _$rapyd$_modules["vyom.utils"];
    _$rapyd$_modules["vyom"]["controllers"] = _$rapyd$_modules["vyom.controllers"];
    _$rapyd$_modules["vyom"]["events"] = _$rapyd$_modules["vyom.events"];
})();

(function(){
    var __name__ = "vyom.parser";
    var BYID, BYELEM, CUR_ID;
    var Exception = _$rapyd$_modules["vyom"].Exception;
    
    function get_data_type(elem) {
        return jQuery(elem).data("type");
    }
    function get_data_args(elem) {
        var args;
    ...
    function get_ctor(name) {
        var last_dot, mod, obj;
        last_dot = name.lastIndexOf(".");
        if (last_dot === -1) {
            return _$rapyd$_modules[name] || window[name];
        }
    ...
    function UnknownWidget() {
        if (this._$rapyd$_object_id === undefined) Object.defineProperty(this, "_$rapyd$_object_id", {"value":++_$rapyd$_object_counter});
        UnknownWidget.prototype.__init__.apply(this, arguments);
    }
    _$rapyd$_extends(UnknownWidget, Exception);
    UnknownWidget.prototype.__init__ = function __init__ () {
        Exception.prototype.__init__ && Exception.prototype.__init__.apply(this, arguments);
    };
    UnknownWidget.prototype.__repr__ = function __repr__ () {
        return "<" + __name__ + "." + "UnknownWidget" + " #" + this._$rapyd$_object_id + ">";
    };
    UnknownWidget.prototype.__str__ = function __str__ () {
        return this.__repr__();
    };
    ...
    function NotASlot() {
        if (this._$rapyd$_object_id === undefined) Object.defineProperty(this, "_$rapyd$_object_id", {"value":++_$rapyd$_object_counter});
        NotASlot.prototype.__init__.apply(this, arguments);
    }
    _$rapyd$_extends(NotASlot, Exception);
    NotASlot.prototype.__init__ = function __init__ () {
        Exception.prototype.__init__ && Exception.prototype.__init__.apply(this, arguments);
    };
    NotASlot.prototype.__repr__ = function __repr__ () {
        return "<" + __name__ + "." + "NotASlot" + " #" + this._$rapyd$_object_id + ">";
    };
    NotASlot.prototype.__str__ = function __str__ () {
        return this.__repr__();
    };
    ...
    CUR_ID = 1;
    function parse() {
        var node = (arguments[0] === undefined || ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true)) ? (null) : arguments[0];
        var _$rapyd$_kwargs_obj = arguments[arguments.length-1];
        if (_$rapyd$_kwargs_obj === null || typeof _$rapyd$_kwargs_obj !== "object" || _$rapyd$_kwargs_obj [_$rapyd$_kwargs_symbol] !== true) _$rapyd$_kwargs_obj = {};
        if (Object.prototype.hasOwnProperty.call(_$rapyd$_kwargs_obj, "node")){
            node = _$rapyd$_kwargs_obj.node;
        }
        var dtype, ctor, args, auto_id, instance, elem;
        if (node === null) {
            node = document.body;
        }
        var _$rapyd$_Iter0 = _$rapyd$_Iterable(Array.prototype.slice.call(node.getElementsByTagName("*")));
        for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
            ...
            ctor = get_ctor(dtype);
            if (!ctor) {
                throw new UnknownWidget(dtype + " is not a widget class");
            }
    ...
    function by_node(node) {
        return BYELEM[node];
    }
    _$rapyd$_modules["vyom.parser"]["BYID"] = BYID;

    _$rapyd$_modules["vyom.parser"]["BYELEM"] = BYELEM;

    _$rapyd$_modules["vyom.parser"]["CUR_ID"] = CUR_ID;

    _$rapyd$_modules["vyom.parser"]["get_data_type"] = get_data_type;

    _$rapyd$_modules["vyom.parser"]["get_data_args"] = get_data_args;

    _$rapyd$_modules["vyom.parser"]["get_ctor"] = get_ctor;

    _$rapyd$_modules["vyom.parser"]["UnknownWidget"] = UnknownWidget;

    _$rapyd$_modules["vyom.parser"]["NotASlot"] = NotASlot;

    _$rapyd$_modules["vyom.parser"]["parse"] = parse;

    _$rapyd$_modules["vyom.parser"]["by_id"] = by_id;

    _$rapyd$_modules["vyom.parser"]["by_node"] = by_node;
})();

(function(){
    var __name__ = "vyom.utils";
    function init(fn) {
        jQuery(main);
    }
    function debug(msg) {
    ...
    _$rapyd$_modules["vyom.utils"]["init"] = init;

    _$rapyd$_modules["vyom.utils"]["debug"] = debug;
})();

(function(){
    var __name__ = "vyom.controllers";
    var vyom = _$rapyd$_modules["vyom"];
    ...
    Controller.prototype.__init__ = function __init__() {
        var self = this;
        var data = ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true) ? undefined : arguments[0];
        var evts = (arguments[1] === undefined || ( 1 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true)) ? ({}) : arguments[1];
        var _$rapyd$_kwargs_obj = arguments[arguments.length-1];
        if (_$rapyd$_kwargs_obj === null || typeof _$rapyd$_kwargs_obj !== "object" || _$rapyd$_kwargs_obj [_$rapyd$_kwargs_symbol] !== true) _$rapyd$_kwargs_obj = {};
        if (Object.prototype.hasOwnProperty.call(_$rapyd$_kwargs_obj, "evts")){
            evts = _$rapyd$_kwargs_obj.evts;
        }
        self.data = data;
        self.evts = evts;
        self.init();
    ...
    Controller.prototype.postCreate = function postCreate() {
        var self = this;
    };
    Controller.prototype.render = function render() {
        var self = this;
        if (!self.widget) {
            console.log("Controller.render() called before .widget is initialised.");
            return;
        }
        return self.widget.render();
    };
    Controller.prototype.create_widget = function create_widget(cls, data, evts) {
        var self = this;
        return new vyom.ReactyWidget(self, cls, data, evts);
    };
    Controller.prototype.emit = function emit(signal, data, evt) {
        var self = this;
        if (self.evts && self.evts[signal]) {
            self.evts[signal](data, evt);
        }
    };
    Controller.prototype.__repr__ = function __repr__ () {
        return "<" + __name__ + "." + "Controller" + " #" + this._$rapyd$_object_id + ">";
    };
    Controller.prototype.__str__ = function __str__ () {
        return this.__repr__();
    };

    function PTController() {
        if (this._$rapyd$_object_id === undefined) Object.defineProperty(this, "_$rapyd$_object_id", {"value":++_$rapyd$_object_counter});
        PTController.prototype.__init__.apply(this, arguments);
    }
    _$rapyd$_extends(PTController, Controller);
    PTController.prototype.__init__ = function __init__ () {
        Controller.prototype.__init__ && Controller.prototype.__init__.apply(this, arguments);
    };
    PTController.prototype.init = function init() {
        var self = this;
        self.widget = self.create_widget(self.component, self.data, self.evts);
    };
    PTController.prototype.__repr__ = function __repr__ () {
        return "<" + __name__ + "." + "PTController" + " #" + this._$rapyd$_object_id + ">";
    };
    PTController.prototype.__str__ = function __str__ () {
        return this.__repr__();
    };

    _$rapyd$_modules["vyom.controllers"]["Controller"] = Controller;

    _$rapyd$_modules["vyom.controllers"]["PTController"] = PTController;
})();

(function(){
    var __name__ = "vyom.events";
    var NotPassed = _$rapyd$_modules["vyom"].NotPassed;
    
    function merge(o1, o2) {
        var o, key;
        o = {};
        var _$rapyd$_Iter0 = _$rapyd$_Iterable(o1);
        for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
        ...
        var _$rapyd$_Iter1 = _$rapyd$_Iterable(o2);
    ...
    function Observable() {
        var val = (arguments[0] === undefined || ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true)) ? (null) : arguments[0];
        var _$rapyd$_kwargs_obj = arguments[arguments.length-1];
        if (_$rapyd$_kwargs_obj === null || typeof _$rapyd$_kwargs_obj !== "object" || _$rapyd$_kwargs_obj [_$rapyd$_kwargs_symbol] !== true) _$rapyd$_kwargs_obj = {};
        if (Object.prototype.hasOwnProperty.call(_$rapyd$_kwargs_obj, "val")){
            val = _$rapyd$_kwargs_obj.val;
        }
        var value, connections, ovable;
        value = val;
        connections = list();
        ovable = function() {
            var val = (arguments[0] === undefined || ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true)) ? (NotPassed) : arguments[0];
            var replace = (arguments[1] === undefined || ( 1 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true)) ? (false) : arguments[1];
            var _$rapyd$_kwargs_obj = arguments[arguments.length-1];
            if (_$rapyd$_kwargs_obj === null || typeof _$rapyd$_kwargs_obj !== "object" || _$rapyd$_kwargs_obj [_$rapyd$_kwargs_symbol] !== true) _$rapyd$_kwargs_obj = {};
            if (Object.prototype.hasOwnProperty.call(_$rapyd$_kwargs_obj, "val")){
                val = _$rapyd$_kwargs_obj.val;
            ...
            var _$rapyd$_Iter2 = _$rapyd$_Iterable(connections);
            for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
                fn = _$rapyd$_Iter2[_$rapyd$_Index2];
                fn(value, ovalue);
            }
        };
        ovable.connect = function() {
            var fn = ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true) ? undefined : arguments[0];
            var bind = (arguments[1] === undefined || ( 1 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [_$rapyd$_kwargs_symbol] === true)) ? (NotPassed) : arguments[1];
            var _$rapyd$_kwargs_obj = arguments[arguments.length-1];
            if (_$rapyd$_kwargs_obj === null || typeof _$rapyd$_kwargs_obj !== "object" || _$rapyd$_kwargs_obj [_$rapyd$_kwargs_symbol] !== true) _$rapyd$_kwargs_obj = {};
            if (Object.prototype.hasOwnProperty.call(_$rapyd$_kwargs_obj, "bind")){
                bind = _$rapyd$_kwargs_obj.bind;
            }
    ...
    _$rapyd$_modules["vyom.events"]["merge"] = merge;

    _$rapyd$_modules["vyom.events"]["Observable"] = Observable;
})();

var __name__ = "__main__";

var todos;
var parse = _$rapyd$_modules["vyom.parser"].parse;

var init = _$rapyd$_modules["vyom.utils"].init;

var Controller = _$rapyd$_modules["vyom.controllers"].Controller;

var Observable = _$rapyd$_modules["vyom.events"].Observable;

function Header() {
    if (this._$rapyd$_object_id === undefined) Object.defineProperty(this, "_$rapyd$_object_id", {"value":++_$rapyd$_object_counter});
    Header.prototype.__init__.apply(this, arguments);
}
_$rapyd$_extends(Header, Controller);
...
Header.prototype.__repr__ = function __repr__ () {
    return "<" + __name__ + "." + "Header" + " #" + this._$rapyd$_object_id + ">";
};
Header.prototype.__str__ = function __str__ () {
    return this.__repr__();
};

function ShowHide() {
    if (this._$rapyd$_object_id === undefined) Object.defineProperty(this, "_$rapyd$_object_id", {"value":++_$rapyd$_object_counter});
    ShowHide.prototype.__init__.apply(this, arguments);
}
_$rapyd$_extends(ShowHide, Controller);
ShowHide.prototype.__init__ = function __init__ () {
    Controller.prototype.__init__ && Controller.prototype.__init__.apply(this, arguments);
};
ShowHide.prototype.show_hide_init = function show_hide_init() {
    var self = this;
    self.show_hide();
    todos.connect(self.show_hide.bind(self));
};
ShowHide.prototype.show_hide = function show_hide() {
    var self = this;
...
ShowHide.prototype.__repr__ = function __repr__ () {
    return "<" + __name__ + "." + "ShowHide" + " #" + this._$rapyd$_object_id + ">";
};
ShowHide.prototype.__str__ = function __str__ () {
    return this.__repr__();
};
...
_$rapyd$_extends(Main, ShowHide);
Main.prototype.__init__ = function __init__ () {
    ShowHide.prototype.__init__ && ShowHide.prototype.__init__.apply(this, arguments);
};
...
Main.prototype.__repr__ = function __repr__ () {
    return "<" + __name__ + "." + "Main" + " #" + this._$rapyd$_object_id + ">";
};
...
_$rapyd$_extends(Footer, ShowHide);
...
Footer.prototype.__repr__ = function __repr__ () {
    return "<" + __name__ + "." + "Footer" + " #" + this._$rapyd$_object_id + ">";
};
Footer.prototype.__str__ = function __str__ () {
    return this.__repr__();
};

todos = Observable(_$rapyd$_list_decorate([]));
function main() {
    console.log("yo");
    parse();
}
